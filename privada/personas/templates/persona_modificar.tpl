		...
		<div class="formu_ingreso_datos">
			<form action="persona_modificar1.php" method="post" name="formu">
				...
				<p>
					...
					<input type="hidden" name="id_personas" value="{$r.id_persona}" >
					<input type="button" name="Aceptar" onclick="validar();" class="boton2" value="Aceptar">
					<input type="button" name="Cancelar" onclick="javascript:location.href='personas.php';" class="boton2" value="Cancelar">
				</p>
				{/foreach}
