	...
	<head>
		...
		<script type="text/javascript">
			function validar(){
				...
				ventanaCalendario = window.open("tareas_fechas1.php?fecha1="+ fecha1 +"&fecha2=" +fecha2 , "calendario", "width=600, height=550, left=100, scrollbars=yes,menubars=no,statusbar=NO,resizable=YES,location=NO")
			}
		</script>
	</head>
	<body>
		<center>
			<br>
			<h1>REPORTES DE TAREAS CON FECHAS DE INICIO</h1>
