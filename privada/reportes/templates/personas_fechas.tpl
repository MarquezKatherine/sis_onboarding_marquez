		...
		<script type="text/javascript">
			function validar(){
				...
				if((document.formu.date1.value == "") || (document.formu.date2.value== "") || (document.formu.date1.value > document.formu.date2.value)){
					alert("Las fechas som imcorrectas");
					document.formu.date1.focus();
					return;
				}
				ventanaCalendario = window.open("personas_fechas1.php?fecha1="+ fecha1 +"&fecha2=" +fecha2 , "calendario", "width=600, height=550, left=100, scrollbars=yes,menubars=no,statusbar=NO,resizable=YES,location=NO")
			}
		</script>
	</head>
	<body>
