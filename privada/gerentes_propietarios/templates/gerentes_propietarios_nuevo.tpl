...
<body>
	<h1>REGISTRAR GERENTE PROPIETARIO</h1>
	<center>
		<form action="gerentes_propietarios_nuevo1.php" method="post" name="formu">
			<table border="1">
				<tr>
				...
				<tr>
					...
					<th>:</th>
					<td><input type="text" name="apellidos" size="15" placeholder="Apellidos"> </td>
				</tr>
				<tr>
					<th align="right">Telefono (*)</th>
					<th>:</th>
					<td><input type="text" name="telefono" size="15" placeholder="Telefono"> </td>
				</tr>
				<tr>
					<th align="right">NIT (*)</th>
					<th>:</th>
					<td><input type="text" name="identificacion_tributaria" size="15" placeholder="Identificacion Tributaria"> </td>
				</tr>
			<tr>
				<td align="center" colspan="3">
				<input type="hidden" name="accion" value="">
				<input type="button" value="Aceptar" onclick="validar();">
				<input type="button" value="Cancelar" onclick="javascript:location.href='gerentes_propietarios.php';">
				</td>
			</tr>
			</table>
			<table>
