			...
			<fieldset>
					...
					<p>	
						...
						<p>
							...
							<input type="Numero" name="periodo_funcionamiento" placeholder="Periodo de Funcionamiento (*)" value="{$r.periodo_funcionamiento}">
							<br>
							Utilidades Historicas:<br>
							<input type="Numero" name="utilidades_historicas" placeholder="Utilidades Historicas (*)" value="{$r.utilidades_historicas}">
							<br>
							Perdidas Historicas:<br>
							<input type="Numero" name="perdidas_historicas" placeholder="Perdidas Historicas (*)" value="{$r.perdidas_historicas}">
							<br>
							Deudas Tributarias:<br>
							<input type="Numero" name="deudas_tributarias" placeholder="Deudas Tributarias (*)" value="{$r.deudas_tributarias}">
							<br>
						</p>
						<p>
